...
public class ListWithCapacityToBench
{
    ...
    [Benchmark]
    public List<SimpleDto> Set_Capacity_With_1_000_Items_To_Add()
    {
    ...
    [Benchmark]
    public List<SimpleDto> Set_Capacity_With_5_000_Items_To_Add()
    {
    ...
    [Benchmark]
    public List<SimpleDto> Set_Capacity_With_10_000_Items_To_Add()
    {
    ...
    [Benchmark]
    public List<SimpleDto> Set_Capacity_With_50_000_Items_To_Add()
    {
        var list = new List<SimpleDto>(50_000);
