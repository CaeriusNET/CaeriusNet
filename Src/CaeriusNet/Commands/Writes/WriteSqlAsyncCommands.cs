...
public static class WriteSqlAsyncCommands
{
	...
	/// </returns>
	public static async Task<T?> ExecuteScalarAsync<T>(this ICaeriusNetDbContext netDbContext,
        StoredProcedureParameters spParameters, CancellationToken cancellationToken = default)
    {
        return await SqlCommandUtility.ExecuteCommandAsync(netDbContext, spParameters, async command =>
        {
	...
	/// </returns>
	public static async Task<int> ExecuteNonQueryAsync(this ICaeriusNetDbContext netDbContext,
        StoredProcedureParameters spParameters, CancellationToken cancellationToken = default)
    {
        return await SqlCommandUtility.ExecuteCommandAsync(netDbContext, spParameters,
	...
	/// </returns>
	public static async Task ExecuteAsync(this ICaeriusNetDbContext netDbContext,
        StoredProcedureParameters spParameters,
        CancellationToken cancellationToken = default)
    {
        await SqlCommandUtility.ExecuteCommandAsync<object?>(netDbContext, spParameters, async command =>
        {
