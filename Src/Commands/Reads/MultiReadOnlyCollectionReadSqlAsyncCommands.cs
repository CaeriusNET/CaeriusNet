...
public static class MultiReadOnlyCollectionReadSqlAsyncCommands
{
	extension(ICaeriusNetDbContext netDbContext)
	{
		...
		{
			return await SqlCommandHelper.ExecuteCommandAsync(netDbContext, spParameters, execute: async command => {
		...
		public async Task<(ReadOnlyCollection<TResultSet1>, ReadOnlyCollection<TResultSet2>,
			...
			QueryMultipleReadOnlyCollectionAsync<TResultSet1, TResultSet2, TResultSet3>(StoredProcedureParameters spParameters,
				CancellationToken cancellationToken = default)
			where TResultSet1 : class, ISpMapper<TResultSet1>
			where TResultSet2 : class, ISpMapper<TResultSet2>
		...
		public async Task<(ReadOnlyCollection<TResultSet1>, ReadOnlyCollection<TResultSet2>,
			...
			QueryMultipleReadOnlyCollectionAsync<TResultSet1, TResultSet2, TResultSet3, TResultSet4>(StoredProcedureParameters spParameters,
				CancellationToken cancellationToken = default)
			where TResultSet1 : class, ISpMapper<TResultSet1>
			where TResultSet2 : class, ISpMapper<TResultSet2>
			where TResultSet3 : class, ISpMapper<TResultSet3>
		...
		public async Task<(ReadOnlyCollection<TResultSet1>, ReadOnlyCollection<TResultSet2>,
			...
			QueryMultipleReadOnlyCollectionAsync<TResultSet1, TResultSet2, TResultSet3, TResultSet4, TResultSet5>(StoredProcedureParameters spParameters,
				CancellationToken cancellationToken = default)
			where TResultSet1 : class, ISpMapper<TResultSet1>
			where TResultSet2 : class, ISpMapper<TResultSet2>
			where TResultSet3 : class, ISpMapper<TResultSet3>
