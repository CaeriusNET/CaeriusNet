...
public static partial class LogMessages
{
    ...
    /// <summary>
    ///     Logs when a bulk range of items has been stored in frozen cache
    /// </summary>
    /// <param name="logger">The logger instance</param>
    ...
    [LoggerMessage(
        EventId = 2007,
        Level = LogLevel.Information,
        Message = "Stored {count} item(s) in frozen cache (bulk)")]
    public static partial void LogStoredRangeInFrozenCache(
        this ILogger logger,
        int count);
