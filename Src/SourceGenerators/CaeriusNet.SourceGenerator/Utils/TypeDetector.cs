namespace CaeriusNet.SourceGenerator.Utils;
...
public static class TypeDetector
{
	...
	/// <summary>
	///     Gets the underlying numeric type of an enum.
	/// </summary>
	/// <param name="type">The enum type.</param>
	/// <returns>The underlying type of the enum, or null if the type is not an enum.</returns>
	private static ITypeSymbol? GetEnumUnderlyingType(ITypeSymbol type)
	{
		return !IsEnumType(type) ? null : ((INamedTypeSymbol)type).EnumUnderlyingType;
	}
	...
	/// <summary>
	///     Determines if a type is an enum based on its type name.
	/// </summary>
	/// <param name="typeSymbol">The type symbol to check.</param>
	/// <returns>True if the type is an enum, otherwise False.</returns>
	public static bool IsEnumTypeByName(ITypeSymbol typeSymbol)
	{
